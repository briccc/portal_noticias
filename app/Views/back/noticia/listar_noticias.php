    ...
    <div class="container-fluid ">
       <h1 class="titulos mt-5 mb-5 text-center">Noticias</h1>
    ...
    ?>
       ...
       <a href="<?php echo base_url ('nueva_noticia');?>" class="btn btn-dark ">Nueva Noticia</a>
    <table class="table mt-3">
        ...
        <tbody>
            ...
            <tr>
                ...
                {?>
                    <td><a class="btn btn-danger" href="<?php echo base_url('eliminar/'.$row['id_noticia']);?>">Desactivar</a></td>
                    <?php } else {
                    ?>
                    <td><a class="btn btn-danger" href="<?php echo base_url('activar/'.$row['id_noticia']);?>">Activar</a></td>
                    <?php } ?>
            </tr>
